package com.JEB.trailmaps.cache;
 ...
 */
public class Cache extends MainActivity implements View.OnClickListener, OnSeekBarChangeListener, TextWatcher
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.sample_cache);
        //prevent tile source changes
    ...
    private void downloadJobAlert() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Cache.this);
        ...
        zoom_max.setOnSeekBarChangeListener(Cache.this);
        ...
        zoom_min.setOnSeekBarChangeListener(Cache.this);
        ...
        try {
            if (cache_east != null &&
                ...
                if (startJob)
                {
                    ...
                    mgr.downloadAreaAsync(Cache.this, bb, zoommin, zoommax, new CacheManager.CacheManagerCallback() {
							@Override
							public void onTaskComplete() {
								Toast.makeText(Cache.this, "Download complete!", Toast.LENGTH_LONG).show();
							}

							@Override
							public void onTaskFailed(int errors) {
								Toast.makeText(Cache.this, "Download complete with " + errors + " errors", Toast.LENGTH_LONG).show();
							}
    ...
    private void showCurrentCacheInfo() {
        Toast.makeText(Cache.this, "Calculating..." ,Toast.LENGTH_SHORT).show();

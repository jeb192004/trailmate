...
public class OrvList
{
	...
	public void setList(MainActivity main) {
		...
		items = new OrvListItems();items.setData("Bergland to Sidnaw Route", "","","bergland_to_sidnaw_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Bill Nicholls Route","","", "bill_nicholls_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Black Lake Trail & Route", "","black_lake_trail.kml","black_lake_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Days River Route", "","","days_river_route.kml", "bike","atv","utv");allorvList.add(items);
		//items = new OrvListItems();items.setData("Denton Creek Trail & Route", "","denton_creek_trail.kml","denton_creek_route.kml", "bike","atv","utv","denton_creek_to_st_helen_connector_route.kml");allorvList.add(items);
		items = new OrvListItems();items.setData("Devils Lake Route", "","","devils_lake_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Drummond Island Trail & Route", "","drummond_island_trail.kml","drummond_island_route.kml", "bike","atv","utv");allorvList.add(items);

		items = new OrvListItems();items.setData("Evart Motorcycle Trail", "evart_motorcycle_trail.kml","","", "bike","","");allorvList.add(items);

		items = new OrvListItems();items.setData("Felch Grade Route", "","","felch_grade_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Forest Islands Trail & Route", "","forest_islands_trail.kml","forest_islands_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Freda Grade Route", "","","freda_grade_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Frederic Trail & Route", "","frederic_trail.kml","", "bike","atv","utv");allorvList.add(items);

		items = new OrvListItems();items.setData("Geels to Roscommon Route","","", "geels_to_roscommon_route.kml", "bike","atv","utv");allorvList.add(items);
		//items = new OrvListItems();items.setData("Geels Trail", "","","Geels_Trail.gpx", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Gladwin Trail & Route", "","gladwin_trail.kml","gladwin_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Grand Traverse County to Supply Rd. MCCCT", "grand_traverse_county_to_supply_rd_mccct.kml","","", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Grand Traverse Motorcycle Trail & Route", "grand_traverse_motorcycle_trail.kml","","grand_traverse_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Hancock-Calumet Route", "","","hancock_to_calumet_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Indian Gardens ORV Route", "","","indian_gardens_orv_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Iron River-Marenisco Route","","", "iron_river_to_marenisco_route.kml", "bike","atv","utv");allorvList.add(items);

		items = new OrvListItems();items.setData("Kalkaska Trail & Route","", "kalkaska_trail.kml","kalkaska_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Lake Linden Route","","", "lake_linden_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Lincoln Hills Motorcycle Trail & Route", "lincoln_hills_motorcycle_trail.kml","","lincoln_hills_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Little Manistee Motorcycle Trail & Route", "little_manistee_motorcycle_trail.kml","","little_manistee_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Marquette-Manistique Trail & Route", "","marquette_manistique_trail.kml","marquette_manistique_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("The Meadows Trail", "the_meadows_motorcycle_trail.kml","the_meadows_trail.kml","", "bike","atv","");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Mio Trail & Route", "","mio_trail.kml","mio_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("North Branch Route", "","","north_branch_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("North Missaukee Motorcycle Trail", "north_missaukee_motorcycle_trail.kml","","", "bike","","");allorvList.add(items);
		
		items = new OrvListItems();items.setData("North Missaukee MCCCT", "north_missaukee_motorcycle_trail__mccct.kml","","", "bike","","");allorvList.add(items);
		
		items = new OrvListItems();items.setData("North Missaukee Motorcycle, Trail & Route","","north_missaukee_trail.kml", "north_missaukee_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Ogemaw Hills Trail & Route", "","ogemaw_hills_trail.kml","ogemaw_hills_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Old State House Trail and Route","", "old_state_house_trail.kml","old_state_house_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Ottawa East Connector", "","","ottawa_east_connector.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Powers Arnold Route","","", "powers_arnold_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Red Bridge Trail & Route","", "red_bridge_trail.kml","red_bridge_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Republic-Champion Route", "","","republic_champion_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("Soo-Raco Route","","", "soo_raco_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("Stateline Route", "","","stateline_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("St. Helen Trail & Route", "","st_helen_trail.kml","st_helen_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("St. Ignace-Trout Lake Route", "","","st_ignace_to_trout_lake_route.kml", "bike","atv","utv");allorvList.add(items);

		items = new OrvListItems();items.setData("Tin Cup Spring Motorcycle Trail & Route", "tin_cup_spring_motorcycle_trail.kml","","tin_cup_spring_route.kml", "bike","atv","utv");allorvList.add(items);
		...
		items = new OrvListItems();items.setData("West Higgins Trail and Route", "","west_higgins_trail.kml","west_higgins_route.kml", "bike","atv","utv");allorvList.add(items);
		items = new OrvListItems();items.setData("White Cloud Loop", "","white_cloud_loop.kml","", "bike","atv","");allorvList.add(items);
		items = new OrvListItems();items.setData("Wisconsin-Bond Falls Route", "","","wisconsin_bond_falls_route.kml", "bike","atv","utv");allorvList.add(items);
